...
## Phases
1. [phase-01-process-tree-kill-windows.md](phase-01-process-tree-kill-windows.md) - Implement reliable Windows Process Tree Kill helper & wire to session lifecycle in `TerminalManager`.
2. [phase-02-web-links-click-to-open.md](phase-02-web-links-click-to-open.md) - Add `@xterm/addon-web-links` script and wire click handler in `standalone.html` / `standalone.js` with `standalone-preload.ts` IPC.
3. [phase-03-tests-and-verification.md](phase-03-tests-and-verification.md) - Add unit & contract tests, verify clean process termination and web-link opening, and verify full test suite.
