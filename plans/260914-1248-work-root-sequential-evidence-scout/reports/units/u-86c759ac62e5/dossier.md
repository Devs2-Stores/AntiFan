# Dossier: customizes\Starsolution

Unit u-86c759ac62e5 | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 364 | analyzed-with-claims: 311 | metadata-only (binary/media): 53 | blocked: 0 | pending: 0
- Read errors: 0
