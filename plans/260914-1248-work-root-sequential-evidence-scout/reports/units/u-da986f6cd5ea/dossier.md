# Dossier: customizes\Zesta

Unit u-da986f6cd5ea | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 514 | analyzed-with-claims: 236 | metadata-only (binary/media): 278 | blocked: 0 | pending: 0
- Read errors: 0
