# Dossier: customizes\Remolacha

Unit u-a986eca9eb3b | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 277 | analyzed-with-claims: 172 | metadata-only (binary/media): 105 | blocked: 0 | pending: 0
- Read errors: 0
