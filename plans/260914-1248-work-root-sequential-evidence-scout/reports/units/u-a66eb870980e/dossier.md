# Dossier: apps\AntiFan\15092026

Unit u-a66eb870980e | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 243 | analyzed-with-claims: 145 | metadata-only (binary/media): 98 | blocked: 0 | pending: 0
- Read errors: 0
