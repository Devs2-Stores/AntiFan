# Dossier: customizes\GomDatViet

Unit u-600467742be6 | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 455 | analyzed-with-claims: 169 | metadata-only (binary/media): 286 | blocked: 0 | pending: 0
- Read errors: 0
