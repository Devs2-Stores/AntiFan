# Dossier: customizes\Sunriseplus

Unit u-a6ca40c7865b | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 331 | analyzed-with-claims: 103 | metadata-only (binary/media): 228 | blocked: 0 | pending: 0
- Read errors: 0
