...
Unit u-a7ff91d2c9b9 | kind=top-level | root=work-root | markers=top-level-dir
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 857 | analyzed-with-claims: 52 | metadata-only (binary/media): 805 | blocked: 0 | pending: 0
- Read errors: 0
