# Dossier: customizes\SittoVietnam

Unit u-790a5f754b70 | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 856 | analyzed-with-claims: 346 | metadata-only (binary/media): 510 | blocked: 0 | pending: 0
- Read errors: 0
