# Dossier: .antifan-data

Unit u-43d543df65b0 | kind=top-level | root=work-root | markers=top-level-dir
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 3050 | analyzed-with-claims: 8 | metadata-only (binary/media): 3038 | blocked: 4 | pending: 0
- Read errors: 0
