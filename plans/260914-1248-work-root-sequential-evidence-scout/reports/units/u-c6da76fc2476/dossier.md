# Dossier: customizes\Luxvie

Unit u-c6da76fc2476 | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 269 | analyzed-with-claims: 232 | metadata-only (binary/media): 37 | blocked: 0 | pending: 0
- Read errors: 0
