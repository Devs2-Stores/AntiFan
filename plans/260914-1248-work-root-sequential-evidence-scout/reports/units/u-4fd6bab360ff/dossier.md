# Dossier: apps\AntiFan\themes\universal-haravan-base

Unit u-4fd6bab360ff | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 43 | analyzed-with-claims: 41 | metadata-only (binary/media): 2 | blocked: 0 | pending: 0
- Read errors: 0
