# Dossier: apps\AntiFan\themes\roahtrip-haravan

Unit u-f6b6feeeee64 | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 28 | analyzed-with-claims: 28 | metadata-only (binary/media): 0 | blocked: 0 | pending: 0
- Read errors: 0
