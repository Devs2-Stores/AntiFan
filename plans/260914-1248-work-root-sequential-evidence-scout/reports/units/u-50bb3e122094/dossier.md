# Dossier: apps\Lucky Code\Storefront

Unit u-50bb3e122094 | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 444 | analyzed-with-claims: 299 | metadata-only (binary/media): 145 | blocked: 0 | pending: 0
- Read errors: 0
