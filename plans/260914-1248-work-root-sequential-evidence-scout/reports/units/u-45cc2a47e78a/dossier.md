# Dossier: customizes\Toda

Unit u-45cc2a47e78a | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 1744 | analyzed-with-claims: 551 | metadata-only (binary/media): 1193 | blocked: 0 | pending: 0
- Read errors: 0
