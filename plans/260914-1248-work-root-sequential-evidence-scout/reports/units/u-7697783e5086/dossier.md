...
Unit u-7697783e5086 | kind=loose-files | root=skills-claude | markers=root-level-files
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 1 | analyzed-with-claims: 0 | metadata-only (binary/media): 1 | blocked: 0 | pending: 0
- Read errors: 0
