# Dossier: customizes\FarmerMarket

Unit u-01191d923e36 | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 528 | analyzed-with-claims: 224 | metadata-only (binary/media): 304 | blocked: 0 | pending: 0
- Read errors: 0
