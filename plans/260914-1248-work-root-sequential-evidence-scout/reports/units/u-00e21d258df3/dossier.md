# Dossier: customizes\Starsolution\live

Unit u-00e21d258df3 | kind=theme | root=work-root | markers=theme-project
Generated by analyze-unit/1.0 (mechanical extraction). Semantic depth limited; see Unknowns.

## Coverage
- Eligible files: 286 | analyzed-with-claims: 248 | metadata-only (binary/media): 38 | blocked: 0 | pending: 0
- Read errors: 0
