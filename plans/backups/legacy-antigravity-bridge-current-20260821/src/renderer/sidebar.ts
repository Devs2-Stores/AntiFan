...
interface AntiFanSidebarApi {
  ...
  switchChatMode: (mode: 'legacy' | 'standalone') => Promise<string>;
...
const btnOpenStandalone = document.getElementById('btnOpenStandalone') as HTMLButtonElement | null;
btnOpenStandalone?.addEventListener('click', () => { void getApi()?.switchChatMode('standalone'); });
