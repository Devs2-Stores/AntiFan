...
const CHANNELS = {
  ...
  SWITCH_CHAT_MODE: 'antifan:toolbar:switch-chat-mode',
...
const toolbarApi = {
  ...
  switchChatMode: (mode: 'legacy' | 'standalone') => ipcRenderer.invoke(CHANNELS.SWITCH_CHAT_MODE, mode),
  ...
  setOverlay: (active: boolean) => ipcRenderer.invoke(CHANNELS.SET_OVERLAY, active),
